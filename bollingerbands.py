...
from config import *
import time
api_key = key     # passkey (saved in bashrc for linux)
api_secret = secret  # secret (saved in bashrc for linux)
...
print("start")
for i in range (1000):
    if(bollinger_trade_logic() != "WAIT"):
        cpt += 1
    cptTot += 1
    time.sleep(2)
print("Résultat : ")
print(" SELL/BUY : " + str(cpt))
print(" Essais : " + str(cptTot))
"""